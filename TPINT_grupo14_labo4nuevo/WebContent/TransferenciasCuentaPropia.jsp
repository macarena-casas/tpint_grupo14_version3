							...
							<form class="d-flex flex-column align-items-center w-100"
								...
								<div class="form-group ancho">
									<label for="CuentaOrigen" class="font-weight-bold">Cuenta
										...
										%>
										<option value="<%=cuenta.getCbu()%>">N°
											<%=cuenta.getNroCuenta()%></option>
										<%
											}
										%>
										<%
								...
								<div class="form-group ancho">
									<label for="CuentaDestino" class="font-weight-bold">Cuenta
										de Destino</label> <select id="CuentaDestino" name="CuentaDestino"
										class="form-control">
										<%
											if (cuentasPorCliente != null && !cuentasPorCliente.isEmpty()) {
										%>
								...
								<div class="form-group ancho">
									<label for="detalleTransferencia" class="font-weight-bold">Detalle:</label>
									<input type="text" required minlength="3" maxlength="150"
										id="detalleTransferencia" name="detalleTransferencia"
										class="form-control">
								</div>
								<div class="form-group ancho">
								...
								<div class="d-flex flex-column align-items-center w-100">
									<button type="submit" name="btnTransferir"
