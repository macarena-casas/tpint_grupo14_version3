							...
							<form action="ServletReportes" method="post"
								...
								<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
									<div class="form-group">
										<label class="font-weight-bold" for="fechaInicio">Fecha
											...
											name="fechaInicio" class="form-control border-black" required>
									</div>
									<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
									<label class="block text-gray-700 text-sm font-bold mb-2"
										...
										type="text" id="DNIclienteReporte" minlength="8" maxlength="8"
										name="DNIclienteReporte" class="form-control border-black">
								</div>
								<br>
							...
							<form action="ServletReportes" method="post"
								...
								<div class="container py-4">
									...
									<textarea id="textAreaReporte" name="textAreaReporte"
										...
										rows="30" cols="8" style="width: 100%;" ><%=textAreaReporte%></textarea>
								</div>
